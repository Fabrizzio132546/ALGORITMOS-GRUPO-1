...
public class AVLTree<E extends Comparable<E>> extends LinkedBST<E> {
    ...
    private NodeAVL deleteRec(NodeAVL node, E d) {
    ...
    public void preOrderAVL() {
        ...
        preOrderAVLRec((NodeAVL) this.root);
        System.out.println();
    }

    private void preOrderAVLRec(NodeAVL node) {
        if (node != null) {
            System.out.print(node.toString() + " "); 
            preOrderAVLRec((NodeAVL) node.left);
            preOrderAVLRec((NodeAVL) node.right);
        }
    }
